...
int scp_file(const char* local_path, const char* remote_host, const char* remote_path, const char* username, const char* password) 
{
...
int main()
{
    ...
    int result = scp_file(local_path, remote_host, remote_path, username, password);
    if (result != 0) 
    {
